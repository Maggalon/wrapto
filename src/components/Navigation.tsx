  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ease-in-out ${
        scrolled 
          ? "bg-brand-dark/92 backdrop-blur-[12px] border-b border-white/5" 
    ...
    >
      <div className="max-w-[1120px] mx-auto px-4 sm:px-6 lg:px-8 h-14 md:h-16 flex items-center justify-between">
        ...
        <button className={`
          ...
          ${scrolled 
            ? "bg-accent-gold text-brand-dark hover:bg-accent-gold-hover hover:-translate-y-[2px] shadow-[0_4px_20px_rgba(245,166,35,0.25)] hover:shadow-[0_8px_32px_rgba(245,166,35,0.35)]" 
